<?php
 ...
 include_once("header.php"); 
  ...
  if(isset($_POST['login']))
	  {
	$query ="select * from  seeker where Seekeruid='".$_POST['email_id']."'  and Pwd ='".$_POST['password']."'";
	$result = mysql_query($query);
	if(mysql_num_rows($result))
		{
	$row = mysql_fetch_assoc($result);
		$_SESSION['login_user'] = $row['Seekeruid'];
		echo '<script> alert("Login success"); window.location.href = "Seekerhome.php" </script>';
		}
 else
	 {
